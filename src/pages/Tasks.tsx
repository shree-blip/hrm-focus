...
const initialTasks: Task[] = [
  ...
  {
    id: "2",
    title: "Q4 Tax Return Preparation",
    client: "Retail Corp",
            ...
            <div key={column.id} className="flex flex-col">
              ...
              <div className="space-y-3 min-h-[400px]">
                {columnTasks.map((task, index) => (
                  <Card
                    key={task.id}
                    className="group cursor-pointer hover:shadow-md hover:border-primary/20 transition-all animate-scale-in"
