...
const eventTypeConfig: Record<string, { label: string; color: string }> = {
  ...
  reminder: {
    label: "Reminder",
    color: "bg-purple-100 text-purple-700 border-purple-200 dark:bg-purple-950/30 dark:text-purple-400 dark:border-purple-800",
  },
  deadline: {
    label: "Deadline",
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Add an event, reminder, or deadline for this date.
          </DialogDescription>
        </DialogHeader>
