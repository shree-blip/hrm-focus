...
export function ClientReportDownload() {
  ...
  const downloadCSV = () => {
    ...
    const headers = ["Date", "Employee", "Department", "Task", "Time Spent", "Start Time", "End Time", "Status", "Notes"];
    ...
    link.href = url;
    link.download = `${clientName}_work_logs_${format(startDate, "yyyy-MM-dd")}_to_${format(endDate, "yyyy-MM-dd")}.csv`;
    link.click();
