          ...
          {reviewed.length > 0 && (
            <div className="mt-4">
              ...
              {filteredReviewed.length === 0 && (
                <p className="text-sm text-muted-foreground text-center py-4">No requests for this month</p>
              )}
              <Table>
                <TableHeader>
                  <TableRow>
                ...
                <TableBody>
                  {(historyMonth === "all" ? filteredReviewed.slice(0, 10) : filteredReviewed).map((req) => {
                    const empName = req.requester_profile
                      ? `${req.requester_profile.first_name} ${req.requester_profile.last_name}`
                      : "Employee";
              ...
              <div className="p-3 bg-muted rounded-lg text-sm space-y-2">
                ...
                {selectedRequest.attendance_log && (
                  <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                    ...
                    <p>{formatMinutesAsClock(selectedRequest.attendance_log.total_break_minutes)}</p>
                    ...
                    <p>{formatMinutesAsClock(selectedRequest.attendance_log.total_pause_minutes)}</p>
