...
const ALL_MENU_ITEMS: MenuItem[] = [
  ...
  { icon: UserPlus, label: "My Onboarding", href: "/my-onboarding", alwaysVisible: true, hideIfHas: ["manage_onboarding"] },
  { icon: UserMinus, label: "My Offboarding", href: "/my-offboarding", alwaysVisible: true, hideIfHas: ["manage_onboarding"] },
  { icon: Wallet, label: "Payroll", href: "/payroll", permissions: ["manage_payroll", "view_payroll"] },
  { icon: Wallet, label: "Payroll", href: "/my-payslips", alwaysVisible: true, hideIfHas: ["manage_payroll", "view_payroll"] },
